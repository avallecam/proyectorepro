...
-   [`DESCRIPTION`](https://github.com/avallecam/proyectorepro/tree/master/DESCRIPTION):
    contains project metadata (authors, date, dependencies, etc.)

-   [`make.R`](https://github.com/avallecam/proyectorepro/tree/master/make.R):
    main R script to run the entire project

-   [`R/`](https://github.com/avallecam/proyectorepro/tree/master/R):
...
Guidelines](https://github.com/avallecam/proyectorepro/blob/main/CONTRIBUTING.md).
