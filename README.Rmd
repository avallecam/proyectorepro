...
Launch the [`make.R`](https://github.com/avallecam/proyectorepro/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/avallecam/proyectorepro/blob/main/CONTRIBUTING.md).
